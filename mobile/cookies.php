...
style="vertical-align: top; margin-top: -4px; margin-left: -2px; max-height: 45px; max-width: 200px;"/></a>
	    ...
	    <div data-role="navbar">
	    	<ul>
	            <li><a id="home" href="./"><?echo $_['Home']; ?></a><span class="ui-icon ui-icon-custom"></span></li>
...
<h3><?php $_['Cookies are not enabled']; ?></h3>
<p><?php echo $_['cookies']; ?></p>
<?php echo $_['You can click here once you have enabled them again to start shopping.']; ?>
